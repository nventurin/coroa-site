...
if( ! empty( $_POST['email'] ) ) {
	...
	$receiver_email = 'nilo.neto@coroa.com.br';
	...
	if( $enable_mailchimp == 'no' ) { // Simple / SMTP Email
		...
		if( $enable_smtp == 'no' ) { // Simple Email
			...
			$mail->isSMTP();
			$mail->Host     = 'smtplw.com.br'; // Your SMTP Host
			$mail->SMTPAuth = true;
			$mail->Username = 'coroa2'; // Your Username
			$mail->Password = 'xfoJrEwr4994'; // Your Password
			$mail->SMTPSecure = 465; // Your Secure Connection
